...
def write_benchmark_core_report(
    ...
    lines = [
        ...
        "",
        "我把这轮 benchmark 拆成 Harness regression、context ablation、working memory ablation 和 recovery ablation 四层，不把 provider、run aggregation 或 durable memory 的其他结论揉进来。",
        "",
        "## Harness Regression",
